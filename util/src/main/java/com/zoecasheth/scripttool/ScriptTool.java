package com.zoecasheth.scripttool;

import com.zoecasheth.scripttool.Entity.CachedResult;
import com.zoecasheth.scripttool.Entity.ParseState;
import com.zoecasheth.scripttool.Entity.TokenscriptFunction;
import com.zoecasheth.scripttool.Ethereum.TransactionHandler;
        ...
        for (String arg : args)
        {
            switch (p)
            {
                case ARG:
                    ...
                    {
                        case "-tokenscript":
                            p = ParseState.TS_FILE;
                            break;
                        case "-address":
                            p = ParseState.USER_ADDR;
                            break;
                        case "-help":
                            showUsage();
                            break;
