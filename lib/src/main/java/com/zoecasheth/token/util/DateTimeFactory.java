...
public abstract class DateTimeFactory
{
    ...
    {
        return new com.zoecasheth.token.util.ZonedDateTime(unixTime, timezone);
    }
    ...
    public static DateTime getDateTime(NonFungibleToken.Attribute timeAttr) throws ParseException, IllegalArgumentException
    {
        ...
        else
        {
            ...
            return new com.zoecasheth.token.util.GeneralDateTime(timeAttr);
        }
    }
    ...
    {
        return new com.zoecasheth.token.util.GeneralDateTime(String.valueOf(System.currentTimeMillis()));
    }
    ...
    private static DateTime initZonedTime(String time) throws ParseException, IllegalArgumentException
    {
        ...
        {
            return new com.zoecasheth.token.util.GeneralDateTime(time);
        }
        else
        {
