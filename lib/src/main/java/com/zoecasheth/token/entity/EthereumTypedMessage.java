...
import static com.zoecasheth.token.entity.MessageUtils.encodeParams;
import static com.zoecasheth.token.entity.MessageUtils.encodeValues;
...
public class EthereumTypedMessage implements Signable {
    ...
    public EthereumTypedMessage(String messageData, String domainName, long callbackId, CryptoFunctionsInterface cryptoFunctions)
    {
        try
        {
            try
            {
                com.zoecasheth.token.entity.ProviderTypedData[] rawData = new Gson().fromJson(messageData, ProviderTypedData[].class);
