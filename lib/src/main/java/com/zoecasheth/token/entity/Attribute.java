...
import com.zoecasheth.token.util.DateTime;
import com.zoecasheth.token.util.DateTimeFactory;
...
public class Attribute {
    ...
    public com.zoecasheth.token.entity.As as;
    ...
    public Attribute(Element attr, TokenDefinition def) throws SAXException
    {
        ...
        as = com.zoecasheth.token.entity.As.Unsigned; //default value
            ...
            if (node.getNodeType() == Node.ELEMENT_NODE) {
                ...
                switch(element.getAttribute("contract").toLowerCase()) {
                    case "holding-contract":
                        setAs(com.zoecasheth.token.entity.As.Mapping);
        ...
        switch (syntax)
        {
            ...
            case GeneralizedTime:
                try
                {
                    ...
                    com.zoecasheth.token.util.DateTime dt = com.zoecasheth.token.util.DateTimeFactory.getDateTime(data);
            ...
            case NumericString:
                ...
                else if (data.startsWith("0x") && this.as != com.zoecasheth.token.entity.As.Address) //Address is a special case where we want the leading 0x
                {
    ...
    public String toString(BigInteger data) throws UnsupportedEncodingException
    {
        ...
        switch (getAs())
        {
            ...
            case Bytes:
                return com.zoecasheth.token.tools.Numeric.toHexString(data.toByteArray());
    ...
    {
        byte[] padded = com.zoecasheth.token.tools.Numeric.toBytesPadded(data, ADDRESS_LENGTH_IN_BYTES);
        String addr = com.zoecasheth.token.tools.Numeric.toHexString(padded);
    ...
    public com.zoecasheth.token.entity.As getAs()
    {
        return as;
    }

    public void setAs(com.zoecasheth.token.entity.As as)
    {
        this.as = as;
    }
