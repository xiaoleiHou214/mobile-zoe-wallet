...
public class MessageUtils
{
     ...
     * @return
     */
    public static byte[] encodeParams(com.zoecasheth.token.entity.ProviderTypedData[] rawData)
    {
     ...
     * @return
     */
    public static byte[] encodeValues(com.zoecasheth.token.entity.ProviderTypedData[] rawData) throws IOException
    {
        int size;
        ByteArrayOutputStream buffer = new ByteArrayOutputStream();
        com.zoecasheth.token.entity.EthereumWriteBuffer eb = new EthereumWriteBuffer(buffer);
