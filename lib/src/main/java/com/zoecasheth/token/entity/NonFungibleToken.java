...
public class NonFungibleToken
{
    ...
    public NonFungibleToken(BigInteger tokenId, com.zoecasheth.token.tools.TokenDefinition ad, Map<String, FunctionDefinition> functionMappings) {
        this(tokenId);
        ad.parseField(tokenId, this, functionMappings);
    }

    public NonFungibleToken(BigInteger tokenId, com.zoecasheth.token.entity.TokenScriptResult tsr) {
        this(tokenId);
