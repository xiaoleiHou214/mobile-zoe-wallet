...
import com.zoecasheth.token.entity.CryptoFunctionsInterface;

import static com.zoecasheth.token.entity.MagicLinkInfo.mainnetMagicLinkDomain;
...
public class ParseMagicLink
{
    ...
    private com.zoecasheth.token.entity.CryptoFunctionsInterface cryptoInterface;

    private Map<Integer, com.zoecasheth.token.entity.ChainSpec> extraChains;

    public ParseMagicLink(CryptoFunctionsInterface cryptInf, List<com.zoecasheth.token.entity.ChainSpec> chains)
    {
        cryptoInterface = cryptInf;
        if (chains != null)
        {
            extraChains = new HashMap<>();
            for (com.zoecasheth.token.entity.ChainSpec cs : chains) extraChains.put(cs.chainId, cs);
        }
    }

    public void addChain(com.zoecasheth.token.entity.ChainSpec chain)
    {
        if (extraChains == null) extraChains = new HashMap<>();
        extraChains.put(chain.chainId, chain);
    }

    public com.zoecasheth.token.entity.MessageData readByteMessage(byte[] message, byte[] sig, int ticketCount) throws com.zoecasheth.token.entity.SalesOrderMalformed
    {
        com.zoecasheth.token.entity.MessageData data = new com.zoecasheth.token.entity.MessageData();
        ByteArrayInputStream bas = new ByteArrayInputStream(message);
        try {
            com.zoecasheth.token.entity.EthereumReadBuffer ds = new com.zoecasheth.token.entity.EthereumReadBuffer(bas);
            ...
            throw new com.zoecasheth.token.entity.SalesOrderMalformed();
        }
        return data;
    }
    ...
    public com.zoecasheth.token.entity.MagicLinkData parseUniversalLink(String link) throws com.zoecasheth.token.entity.SalesOrderMalformed
    {
        int chainId = com.zoecasheth.token.entity.MagicLinkInfo.identifyChainId(link);
        String magicLinkUrlPrefix = com.zoecasheth.token.entity.MagicLinkInfo.getMagicLinkDomainFromNetworkId(chainId);
        ...
        {
            throw new com.zoecasheth.token.entity.SalesOrderMalformed("Invalid link format");
        }
    ...
    private int identifyChain(String link)
    {
        ...
        if (index > 0 && dSlash > 0)
        {
            ...
            for (com.zoecasheth.token.entity.ChainSpec cs : extraChains.values())
            {
    ...
    private com.zoecasheth.token.entity.MagicLinkData getDataFromLinks(com.zoecasheth.token.entity.MagicLinkData data, com.zoecasheth.token.entity.EthereumReadBuffer ds) throws IOException
    {
    ...
    private com.zoecasheth.token.entity.MagicLinkData parseCurrencyLinks(com.zoecasheth.token.entity.MagicLinkData data, com.zoecasheth.token.entity.EthereumReadBuffer ds) throws IOException
    {
    ...
    private com.zoecasheth.token.entity.MagicLinkData getMagicLinkDataFromURL(String linkData, int chainId) throws com.zoecasheth.token.entity.SalesOrderMalformed
    {
        com.zoecasheth.token.entity.MagicLinkData data = new com.zoecasheth.token.entity.MagicLinkData();
     ...
     */
    public String getOwnerKey(com.zoecasheth.token.entity.MagicLinkData data) {
    ...
    private byte[] getTradeBytes(com.zoecasheth.token.entity.MagicLinkData data)
    {
        switch (data.contractType)
        {
            case unassigned:
    ...
    public byte[] getSpawnableBytes(List<BigInteger> tokenIds, String contractAddress, BigInteger priceWei, long expiry)
    {
        try {
            ...
            com.zoecasheth.token.entity.UnsignedLong expiryUL = com.zoecasheth.token.entity.UnsignedLong.create(expiry);

            BigInteger addrBI = new BigInteger(com.zoecasheth.token.tools.Numeric.cleanHexPrefix(contractAddress), 16);
            ds.write(com.zoecasheth.token.tools.Numeric.toBytesPadded(priceWei, 32));
            ds.write(com.zoecasheth.token.tools.Numeric.toBytesPadded(expiryUL, 32));
            ds.write(com.zoecasheth.token.tools.Numeric.toBytesPadded(addrBI, 20));

            for (BigInteger tokenId : tokenIds)
            {
                ds.write(com.zoecasheth.token.tools.Numeric.toBytesPadded(tokenId, 32));
            }
            ds.flush();
            ds.close();
    ...
    private static byte[] generateLeadingLinkBytes(
            ...
            BigInteger priceWei,
            long expiry
    ) throws com.zoecasheth.token.entity.SalesOrderMalformed
    {
        try
        {
            ByteArrayOutputStream buffer = new ByteArrayOutputStream();
            com.zoecasheth.token.entity.EthereumWriteBuffer wb = new com.zoecasheth.token.entity.EthereumWriteBuffer(buffer);

            wb.writeByte(type);

            if (priceWei.compareTo(maxPrice) > 0) {
                throw new com.zoecasheth.token.entity.SalesOrderMalformed("Order's price too high to be used in a link");
            }
    ...
    public static byte[] generateLeadingLinkBytes(int[] ticketSendIndexList, String contractAddress, BigInteger priceWei, long expiry) throws com.zoecasheth.token.entity.SalesOrderMalformed
    {
        return generateLeadingLinkBytes(normal, ticketSendIndexList, null, contractAddress, priceWei, expiry);
    }

    public static byte[] generateSpawnableLeadingLinkBytes(List<BigInteger> tokenIds, String contractAddress, BigInteger priceWei, long expiry) throws com.zoecasheth.token.entity.SalesOrderMalformed
    {
        return generateLeadingLinkBytes(spawnable, null, tokenIds, contractAddress, priceWei, expiry);
    }

    public String generateUniversalLink(int[] thisTickets, String contractAddr, BigInteger price, long expiry, byte[] signature, int chainId) throws com.zoecasheth.token.entity.SalesOrderMalformed
    {
    ...
    public String completeUniversalLink(int chainId, byte[] message, byte[] signature)
    {
        ...
        {
            magiclinkPrefix = com.zoecasheth.token.entity.MagicLinkInfo.generatePrefix(chainId);
        }
