package com.zoecasheth.attestation;

import com.zoecasheth.attestation.Attestation;
import com.zoecasheth.attestation.AttestationManager;
...
public class TestAttestation {
    ...
    private com.zoecasheth.attestation.Attestation makeUnsignedx509Att() {
        com.zoecasheth.attestation.Attestation att = new com.zoecasheth.attestation.Attestation();
        ...
        extensions.add(new ASN1ObjectIdentifier(com.zoecasheth.attestation.Attestation.OID_OCTETSTRING));
    ...
    private com.zoecasheth.attestation.Attestation makeUnsignedAtt() {
        com.zoecasheth.attestation.Attestation att = new com.zoecasheth.attestation.Attestation();
    ...
    public void testGetterSetter() {
        ...
        com.zoecasheth.attestation.Attestation att2 = new com.zoecasheth.attestation.Attestation();
    ...
    public void testSignAttestration() {
        com.zoecasheth.attestation.AttestationManager manager = new com.zoecasheth.attestation.AttestationManager(OID_SHA256ECDSA, issuerKeys);
        com.zoecasheth.attestation.Attestation att = makeUnsignedAtt();
    ...
    public void testX509Comp() throws Exception {
        com.zoecasheth.attestation.AttestationManager manager = new AttestationManager(OID_SHA256ECDSA, issuerKeys);
