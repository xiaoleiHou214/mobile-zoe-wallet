...
public class TokenDefinitionTest implements ParseResult
{
    ...
    public void TokenInformationCanBeExtracted() throws IOException, SAXException {
        ...
        com.zoecasheth.token.tools.TokenDefinition entryToken = new com.zoecasheth.token.tools.TokenDefinition(new FileInputStream(entryTokenTestFile), new Locale("en"), this);
    ...
    public void BadLocaleShouldThrowException() throws IOException, SAXException {
        com.zoecasheth.token.tools.TokenDefinition ticketAsset = new TokenDefinition(new FileInputStream(entryTokenTestFile), new Locale("asdf"), this);
