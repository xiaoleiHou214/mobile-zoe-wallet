...
public class XMLDsigVerifierTest {
    ...
    public void testRSACertSignedByInvalidAuthority() throws Exception {
        ...
        XMLDsigVerificationResult result = new com.zoecasheth.token.tools.XMLDSigVerifier().VerifyXMLDSig(EntryToken);
...
*/
    ...
    public void testFifaSelfIssuedCertECDSA() throws Exception {
        ...
        XMLDsigVerificationResult result = new com.zoecasheth.token.tools.XMLDSigVerifier().VerifyXMLDSig(fileTS);
