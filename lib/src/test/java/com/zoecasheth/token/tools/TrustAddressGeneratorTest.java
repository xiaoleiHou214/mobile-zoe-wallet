...
import com.zoecasheth.token.tools.TrustAddressGenerator;
...
public class TrustAddressGeneratorTest {
    ...
    public TrustAddressGeneratorTest() throws IOException, MarshalException, ParserConfigurationException, SAXException, XMLSignatureException {
        ...
        com.zoecasheth.token.tools.XMLDSigVerifier sigVerifier = new XMLDSigVerifier();
    ...
    public void generateTrustAddress() throws Exception {
        ...
        String trustAddress = com.zoecasheth.token.tools.TrustAddressGenerator.getTrustAddress("0x63cCEF733a093E5Bd773b41C96D3eCE361464942", digest);
