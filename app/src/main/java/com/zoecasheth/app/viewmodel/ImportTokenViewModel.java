...
import com.zoecasheth.app.entity.MagicLinkParcel;
...
import static com.zoecasheth.token.tools.ParseMagicLink.customizable;
...
import static com.zoecasheth.token.tools.ParseMagicLink.unassigned;
...
public class ImportTokenViewModel extends BaseViewModel
{
    ...
    public void performImport()
    {
        try
        {
            ...
            final byte[] tradeData = MagicLinkParcel.generateReverseTradeData(order, importToken, wallet.getValue().address);
