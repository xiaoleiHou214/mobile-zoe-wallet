...
import com.zoecasheth.app.entity.tokenscript.TokenScriptRenderCallback;
import com.zoecasheth.app.entity.tokenscript.WebCompletionCallback;
import com.zoecasheth.app.util.DappBrowserUtils;
import com.zoecasheth.app.util.KeyboardUtils;
...
import com.zoecasheth.app.widget.SignTransactionDialog;
import com.zoecasheth.app.widget.SystemView;
import com.zoecasheth.token.entity.TokenScriptResult;
        ...
        OnSetValuesListener
{
    ...
    private com.zoecasheth.token.entity.EthereumMessage messageToSign;
    private FunctionButtonBar functionBar;
    private final Handler handler = new Handler();
    private int parsePass = 0;
    private int resolveInputCheckCount;
    private com.zoecasheth.token.entity.TSAction action;

    private void initViews() {
        token = getIntent().getParcelableExtra(C.Key.TICKET);
    ...
    private void displayFunction(String tokenAttrs)
    {
        try
        {
            Map<String, com.zoecasheth.token.entity.TSAction> functions = viewModel.getAssetDefinitionService().getTokenFunctionMap(token.tokenInfo.chainId, token.getAddress());
            com.zoecasheth.token.entity.TSAction action = functions.get(actionMethod);
    ...
    private void getAttrs()
    {
        ...
        List<com.zoecasheth.token.entity.Attribute> localAttrs = (action != null && action.attributes != null) ? new ArrayList<>(action.attributes.values()) : null;
    ...
    private void addMultipleTokenIds(StringBuilder sb)
    {
        ...
        {
            for (com.zoecasheth.token.entity.MethodArg arg : action.function.parameters)
            {
    ...
    private void onAttr(com.zoecasheth.token.entity.TokenScriptResult.Attribute attribute)
    {
    ...
    private void resolveUserInput()
    {
        ...
        {
            @Override
            public void calculationCompleted(String value, String result, com.zoecasheth.token.entity.TokenscriptElement e, com.zoecasheth.token.entity.Attribute attr)
            {
                ...
                if (e.value.startsWith(TokenscriptFunction.TOKENSCRIPT_CONVERSION_ERROR)) //handle parse error
                {
                    String message = e.value.substring(TokenscriptFunction.TOKENSCRIPT_CONVERSION_ERROR.length());
        ...
        {
            for (com.zoecasheth.token.entity.TokenscriptElement e : action.function.tx.args.values())
            {
    ...
    private void checkTokenScriptElement(CalcJsValueCallback cb, com.zoecasheth.token.entity.TSAction action, com.zoecasheth.token.entity.TokenscriptElement e)
    {
        if (e.ref != null && e.ref.length() > 0 && action.attributes != null)
        {
            com.zoecasheth.token.entity.Attribute attr = action.attributes.get(e.ref);
    ...
    @Override
    public void signMessage(com.zoecasheth.token.entity.Signable message, DAppFunction dAppFunction)
    {
    ...
    @Override
    public void onSignPersonalMessage(com.zoecasheth.token.entity.EthereumMessage message)
    {
    ...
    public void testRecoverAddressFromSignature(String message, String sig)
    {
        ...
        Sign.SignatureData sd = CryptoFunctions.sigFromByteArray(signatureBytes);
    ...
    {
        if (gotAuth) viewModel.completeAuthentication(Operation.SIGN_DATA);
        else viewModel.failedAuthentication(Operation.SIGN_DATA);
        ...
        if (gotAuth)
        {
            ...
            {
                @Override
                public void DAppError(Throwable error, com.zoecasheth.token.entity.Signable message)
                {
                ...
                @Override
                public void DAppReturn(byte[] data, com.zoecasheth.token.entity.Signable message)
                {
                    showProgressSpinner(false);
    ...
    {
        void calculationCompleted(String value, String result, com.zoecasheth.token.entity.TokenscriptElement e, com.zoecasheth.token.entity.Attribute attr);
        void unresolvedSymbolError(String value);
    }

    private void evaluateJavaScript(CalcJsValueCallback callback, String value, com.zoecasheth.token.entity.TokenscriptElement e, com.zoecasheth.token.entity.Attribute attr)
    {
    ...
    private void getValueFromInnerHTML(CalcJsValueCallback callback, String value, com.zoecasheth.token.entity.TokenscriptElement e, com.zoecasheth.token.entity.Attribute attr)
    {
        tokenView.evaluateJavascript(
                "(function() { var x = document.getElementById(\"" + value + "\");\n" +
                        "            return x.innerHTML; })();",
