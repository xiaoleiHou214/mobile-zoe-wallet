...
import com.zoecasheth.app.entity.walletconnect.WCRequest;
import com.zoecasheth.app.repository.SignRecord;
import com.zoecasheth.app.ui.widget.entity.ActionSheetCallback;
import com.zoecasheth.app.viewmodel.WalletConnectViewModel;
import com.zoecasheth.app.viewmodel.WalletConnectViewModelFactory;
import com.zoecasheth.app.walletconnect.WCClient;
import com.zoecasheth.app.walletconnect.WCSession;
import com.zoecasheth.app.walletconnect.entity.WCEthereumSignMessage;
import com.zoecasheth.app.walletconnect.entity.WCEthereumTransaction;
import com.zoecasheth.app.walletconnect.entity.WCPeerMeta;
...
public class WalletConnectActivity extends BaseActivity implements ActionSheetCallback, StandardFunctionInterface
{
    ...
    private ActionSheetDialog generateTransactionRequest(Web3Transaction w3Tx, int chainId)
    {
        ...
        try
        {
                    ...
                    || (!w3Tx.recipient.equals(Address.EMPTY) && (w3Tx.payload != null || w3Tx.value != null))) // Raw or Function TX
            {
                ...
                viewModel.calculateGasEstimate(viewModel.getWallet(), com.zoecasheth.token.tools.Numeric.hexStringToByteArray(w3Tx.payload),
    ...
    private BigInteger convertToGasLimit(EthEstimateGas estimate, Web3Transaction w3Tx)
    {
        ...
        {
            return new BigInteger(C.DEFAULT_GAS_LIMIT_FOR_NONFUNGIBLE_TOKENS); //cautious gas limit
        }
        else
        {
