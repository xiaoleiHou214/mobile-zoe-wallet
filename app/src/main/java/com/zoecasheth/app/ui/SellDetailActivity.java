...
import com.zoecasheth.app.viewmodel.SellDetailViewModel;
import com.zoecasheth.app.viewmodel.SellDetailModelFactory;
...
public class SellDetailActivity extends BaseActivity implements OnTokenClickListener, Runnable, SignAuthenticationCallback
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ticketIds = getIntent().getStringExtra(C.EXTRA_TOKENID_LIST);
        saleStatus = getIntent().getIntExtra(C.EXTRA_STATE, 0);
        sellPriceValue = getIntent().getDoubleExtra(C.EXTRA_PRICE, 0.0);
