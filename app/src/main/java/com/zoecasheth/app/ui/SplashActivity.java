...
import com.zoecasheth.app.viewmodel.SplashViewModel;
    ...
    private void onWallets(Wallet[] wallets) {
        ...
        if (wallets.length == 0)
        {
            ...
            findViewById(R.id.button_watch).setOnClickListener(v -> {
                new ImportWalletRouter().openWatchCreate(this, C.IMPORT_REQUEST_CODE);
            });
            findViewById(R.id.button_import).setOnClickListener(v -> {
                new ImportWalletRouter().openForResult(this, C.IMPORT_REQUEST_CODE);
            });
        }
        else
        {
