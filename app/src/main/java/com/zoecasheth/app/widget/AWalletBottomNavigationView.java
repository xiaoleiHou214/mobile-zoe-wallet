package com.zoecasheth.app.widget;
...
public class AWalletBottomNavigationView extends LinearLayout {
    ...
    public AWalletBottomNavigationView(Context context, @Nullable AttributeSet attrs) {
        ...
        findViewById(R.id.wallet_tab).setOnClickListener(v -> selectItem(WalletPage.WALLET));
        findViewById(R.id.browser_tab).setOnClickListener(v -> selectItem(WalletPage.DAPP_BROWSER));
        findViewById(R.id.settings_tab).setOnClickListener(v -> selectItem(WalletPage.SETTINGS));
        findViewById(R.id.activity_tab).setOnClickListener(v -> selectItem(WalletPage.ACTIVITY));

        dappBrowser.setOnClickListener(v -> selectItem(WalletPage.DAPP_BROWSER));
        wallet.setOnClickListener(v -> selectItem(WalletPage.WALLET));
        settings.setOnClickListener(v -> selectItem(WalletPage.SETTINGS));
        activity.setOnClickListener(v -> selectItem(WalletPage.ACTIVITY));

        dappBrowserLabel.setOnClickListener(v -> selectItem(WalletPage.DAPP_BROWSER));
        walletLabel.setOnClickListener(v -> selectItem(WalletPage.WALLET));
        settingsLabel.setOnClickListener(v -> selectItem(WalletPage.SETTINGS));
        activityLabel.setOnClickListener(v -> selectItem(WalletPage.ACTIVITY));
    }
