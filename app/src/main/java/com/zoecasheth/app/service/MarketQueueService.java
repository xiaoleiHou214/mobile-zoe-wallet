...
import com.zoecasheth.app.entity.BaseViewCallback;
import com.zoecasheth.app.entity.CryptoFunctions;
import com.zoecasheth.app.entity.TradeInstance;
...
import com.zoecasheth.token.entity.MessageData;
...
public class MarketQueueService {
    ...
    private BigInteger ecRecoverPublicKey(Wallet wallet, String password, int chainId) throws Exception
    {
        ...
        Sign.SignatureData testSig = CryptoFunctions.sigFromByteArray(testSigBytes);
