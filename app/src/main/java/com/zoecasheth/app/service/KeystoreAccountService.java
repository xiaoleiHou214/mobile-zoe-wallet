...
import com.zoecasheth.app.entity.cryptokeys.SignatureReturnType;
...
public class KeystoreAccountService implements AccountKeystoreService
{
     ...
     */
    @Override
    public Single<com.zoecasheth.app.entity.Wallet> createAccount(String password) {
     ...
     */
    @Override
    public Single<com.zoecasheth.app.entity.Wallet> importKeystore(String store, String password, String newPassword) {
        return Single.fromCallable(() -> {
            String address = extractAddressFromStore(store);
            com.zoecasheth.app.entity.Wallet wallet;
            ...
            try {
                ...
                wallet = new com.zoecasheth.app.entity.Wallet(credentials.getAddress());
     ...
     */
    @Override
    public Single<com.zoecasheth.app.entity.Wallet> importPrivateKey(String privateKey, String newPassword) {
        return Single.fromCallable(() -> {
    ...
    @Override
    public Single<String> exportAccount(com.zoecasheth.app.entity.Wallet wallet, String password, String newPassword) {
        return Single
    ...
    @Override
    public Single<SignatureFromKey> signTransaction(com.zoecasheth.app.entity.Wallet signer, String toAddress, BigInteger amount, BigInteger gasPrice, BigInteger gasLimit, long nonce, byte[] data, long chainId) {
        return Single.fromCallable(() -> {
            ...
            sigData = CryptoFunctions.sigFromByteArray(returnSig.signature);
            if (sigData == null) {
    ...
    @Override
    public Single<byte[]> signTransactionFast(com.zoecasheth.app.entity.Wallet signer, String signerPassword, byte[] message, long chainId) {
        return Single.fromCallable(() -> {
    ...
    @Override
    public Single<SignatureFromKey> signTransaction(com.zoecasheth.app.entity.Wallet signer, byte[] message, long chainId)
    {
        return Single.fromCallable(() -> {
    ...
    @Override
    public Single<SignatureFromKey> signMessage(com.zoecasheth.app.entity.Wallet signer, Signable message, long chainId)
    {
        return Single.fromCallable(() -> {
            //byte[] messageHash = Hash.sha3(message);
    ...
    @Override
    public Single<com.zoecasheth.app.entity.Wallet[]> fetchAccounts() {
        return Single.fromCallable(() -> {
            File[] contents = keyFolder.listFiles();
            List<Date> fileDates = new ArrayList<>();
            Map<Date, String> walletMap = new HashMap<>();
            List<com.zoecasheth.app.entity.Wallet> wallets = new ArrayList<>();
            if (contents == null || contents.length == 0) return new com.zoecasheth.app.entity.Wallet[0];
            ...
            for (Date d : fileDates)
            {
                ...
                com.zoecasheth.app.entity.Wallet wallet = new com.zoecasheth.app.entity.Wallet(address);
                wallet.type = WalletType.KEYSTORE;
                wallet.walletCreationTime = d.getTime();
                wallets.add(wallet);
            }

            return wallets.toArray(new com.zoecasheth.app.entity.Wallet[0]);
        })
        .subscribeOn(Schedulers.io());
    }
