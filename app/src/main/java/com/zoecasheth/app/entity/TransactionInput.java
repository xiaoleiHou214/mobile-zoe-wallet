...
import static com.zoecasheth.app.C.BURN_ADDRESS;
...
public class TransactionInput
{
    ...
    public String getOperationValue(Token token, Transaction tx)
    {
        ...
        switch (type)
        {
            ...
            case RECEIVED:
            case SEND:
                operationValue = token.getTransferValue(tx.transactionInput, TransactionHolder.TRANSACTION_BALANCE_PRECISION);
                break;
