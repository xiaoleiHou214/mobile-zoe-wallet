...
import com.zoecasheth.app.entity.opensea.AssetContract;
import com.zoecasheth.app.entity.opensea.Trait;
...
import com.zoecasheth.app.repository.entity.RealmERC721Asset;
        ...
        return Completable.complete()
                .subscribeWith(new DisposableCompletableObserver()
                {
                    ...
                    public void onStart()
                    {
                        ...
                        {
                            writeTickerToRealm(realm, erc20Tickers.get(tokenAddress), EthereumNetworkBase.MAINNET_ID, tokenAddress);
                        }
                    }
        ...
        return Completable.complete()
                .subscribeWith(new DisposableCompletableObserver()
                {
                    ...
                    public void onStart()
                    {
                        ...
                        //get all tickers
                        RealmResults<RealmTokenTicker> realmItems = realm.where(RealmTokenTicker.class)
                                .lessThan("updatedTime", System.currentTimeMillis() - TickerService.TICKER_TIMEOUT)
                                .findAll();
